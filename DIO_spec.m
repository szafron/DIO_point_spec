...
lk=jk+1/2 kappa/Abs[kappa];16/(\[Pi] m^5)*Ee^2 (2 jk+1)*NIntegrate[kk^2*(((Efm-Ee)^2-kk^2)*((Abs[S1[kk,kappa,J,Ee] ]^2)/((J+1) (2 J+1)))+kk^2 (Abs[S4[kk,kappa,J,Ee]]^2+1/(2 J+1)^2 Abs[S1[kk,kappa,J,Ee]]^2)+(Efm-Ee) kk (1/(2 J+1) ((Conjugate[S1[kk,kappa,J,Ee]]) S4[kk,kappa,J,Ee]+Conjugate[(Conjugate[S1[kk,kappa,J,Ee]]) S4[kk,kappa,J,Ee]]))),{kk,0,Efm-Ee}]]
...
Do[specJ=ParallelTable[{Ee,1/(4 Ee^2)NEe[Ee,J,kappa] },{Ee,Emin,Emax,Estep}];
Export[name<>ToString[J]<>"_k"<>ToString[kappa]<>dd,specJ];,{J,Jmin,Jmax,1},{kappa,-(J+1),-J,1}];
